<template>
  <div class="page">
    <div class="header">
      <el-text tag="h1" size="large">Склады</el-text>
    
      <el-text class="header__description" tag="p" size="small">
        На этой странице представлена вся информация о складах компании. Вы можете легко управлять складскими данными, отслеживать остатки и контролировать движение товаров. Удобный интерфейс позволяет эффективно администрировать все процессы хранения.
      </el-text>
